...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # ericjosuehetnandezduran@gmail.com  el correo esta divido en 2 nombre del usuario y dominio de la compania
            ...
            #Logica para generar UserProfile a cada usuario registrado
            profile = UserProfile()
            ...
            mail_subject = "Por favor activa tu cuenta en Pcerdas"
